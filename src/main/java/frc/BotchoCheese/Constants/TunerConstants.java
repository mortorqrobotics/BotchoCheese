...
public class TunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus(RobotMap.CANIVORE_CAN_BUS, getCanivoreLogPath());
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.496337890625);
