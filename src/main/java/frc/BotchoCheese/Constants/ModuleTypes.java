...
public class ModuleTypes {
    ...
    public ModuleTypes(double wheelDiameter, double angleGearRatio, double driveGearRatio, double angleKP, double angleKI, double angleKD, InvertedValue driveMotorInvert, InvertedValue angleMotorInvert, SensorDirectionValue cancoderInvert){
    ...
    public static final class WCP {
        ...
        public static final class SwerveXStandard{
            ...
            public static final ModuleTypes Falcon500(double driveGearRatio){
                ...
                return new ModuleTypes(wheelDiameter, angleGearRatio, driveGearRatio, angleKP, angleKI, angleKD, driveMotorInvert, angleMotorInvert, cancoderInvert);
            }
            
            /** West Coast Products - SwerveX Standard (Kraken X60)*/
            public static final ModuleTypes KrakenX60(double driveGearRatio){
                double wheelDiameter = 4.0;
